...
In addition, both the [sf](https://r-spatial.github.io/sf/) and
[sfnetworks](https://luukvdmeer.github.io/sfnetworks/) R packages are of
key importance to the functionality within `{pathroutr}`. A special
...
your *.Rprofile* and this will ensure
[`update.packages()`](https://rdrr.io/r/utils/update.packages.html)
pulls any new releases of `{pathroutr}`
...
`{pathroutr}` is highly dependent upon the
[sfnetworks](https://luukvdmeer.github.io/sfnetworks/) and
[sf](https://r-spatial.github.io/sf/) packages.

Both are available on CRAN.

Please note that the minimum supported version of
[sf](https://r-spatial.github.io/sf/) is 0.9. So, this might also be a
good time to check and update your [sf](https://r-spatial.github.io/sf/)
package versions.

Core packages from the `tidyverse`
([dplyr](https://dplyr.tidyverse.org),
[purrr](https://purrr.tidyverse.org/), and
[tibble](https://tibble.tidyverse.org/)) are also required.
...
[package](https://reprex.tidyverse.org/) to share code within your
Issue.
